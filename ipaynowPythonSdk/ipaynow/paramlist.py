...
WP001_PostList = [
    ...
    {'name':'frontNotifyUrl'    , 'mandatory':'Y', 'md5':'Y', 'type': 'str', 'len':200, 'desp':"商户前台通知URL"},
    {'name':'mhtCharset'        , 'mandatory':'Y', 'md5':'Y', 'type': 'str', 'len':16,  'desp':"商户字符编码-UTF8"},
    {'name':'deviceType'        , 'mandatory':'Y', 'md5':'N', 'type': 'str', 'len':2,   'desp':"设备类型"},
    ...
    {'name':'consumerName'      , 'mandatory':'N', 'md5':'Y', 'type': 'str', 'len':40,  'desp':"消费者名称"},
